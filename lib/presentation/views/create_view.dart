      ...
      body: SafeArea(
        child: Center(
          ...
          children: [ElevatedButton(
            ...
            style: TextStyle(
            color: Color.fromARGB(255, 29, 29, 29), // Cambia este color según tus necesidades
            ...
            onPressed: () {
              showModalBottomSheet(
                ...
                builder: (BuildContext context) {
                  return Container( // Use a Container here
            ...
            style: ButtonStyle(
        backgroundColor: MaterialStateProperty.all<Color>(AppTheme.colors.red1),
      ),
          ),
          ElevatedButton(
            ...
            onPressed: () {
              showModalBottomSheet(
              context: context,
              isScrollControlled: true, // Permite que el contenido desborde la pantalla
              builder: (BuildContext context) {
                 return Container( // Use a Container here
